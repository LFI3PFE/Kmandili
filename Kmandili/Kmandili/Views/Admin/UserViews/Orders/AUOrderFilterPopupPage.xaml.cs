...
namespace Kmandili.Views.Admin.UserViews.Orders
{
	...
	public partial class AuOrderFilterPopupPage
	{
        ...
        public AuOrderFilterPopupPage(AuOrderList orderList, List<Status> selectedStatuses)
        {
        ...
        private void StatusSwitch_Toggled(object sender, EventArgs e)
        {
            ...
            {
                _selectedStatuses.Remove(_selectedStatuses.FirstOrDefault(s => statusSwitch != null && s.ID == Int32.Parse(statusSwitch.ClassId)));
            }
        }
