...
namespace Kmandili.Views.Admin.PSViews.Orders
{
	...
	public partial class ApOrderList
	{
        ...
        {
            await PopupNavigation.PushAsync(new AOrderFilterPopupPage(this, _selectedStatuses));
        }
        ...
        public async void Load(int id)
        {
            ...
            _orders = _orders.OrderBy(p => p.SeenPastryShop).ToList();
            ...
            var res =
                _orders.Where(
                    o =>
                        ...
                        (_selectedStatuses.Count == 0 || _selectedStatuses.Any(s => s.ID == o.Status_FK))).ToList();
            if (_selectedSortType.SortTypeIndex == 0 && _selectedSortType.IsAsc)
            {
