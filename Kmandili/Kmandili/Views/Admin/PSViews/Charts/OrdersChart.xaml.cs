...
namespace Kmandili.Views.Admin.PSViews.Charts
{
	...
	public partial class OrdersChart : ContentPage
	{
        ...
        public OrdersChart(PastryShop pastryShop)
        {
            InitializeComponent();
        ...
        private async void Load()
        {
            ...
            try
            {
                ...
                {
                    Html = await chartRC.GetChartView(App.ServerURL + "api/GetLineChartView/" + pastryShop.ID + "/" + year + "/" + semester)
                };
